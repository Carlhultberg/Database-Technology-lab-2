...
class Booking_Details():
    def __init__(self, master):
        ...
        cur.execute(sql, (self.booking_date, self.booking_timing))
...
class Select_Participants():
    ...
    def choose_participants(self):
        ...
        cur.execute("SELECT fname, lname FROM person WHERE staff_id = ANY(%s);", (self.participants_selections,))
        conn.commit()
        ...
        cur.execute(sql.SQL("DELETE FROM current_bookings WHERE participants IS NULL"))
        conn.commit()
...
class Show_Times():
    ...
    def choose_time(self):
        ...
        sql = "UPDATE resources SET available = 1 WHERE room_id = %s"
