...
class Booking_Details():
    def __init__(self, master):
        ...
        sql = "WITH availble_rooms AS ( SELECT room_id AS room FROM current_bookings WHERE (current_bookings.booking_date != %s AND current_bookings.booking_timing != %s)) " \
              "SELECT resources.room_id, resources.room_name, resources.room_facilities FROM resources, availble_rooms WHERE resources.room_id = availble_rooms.room GROUP BY room_id"
